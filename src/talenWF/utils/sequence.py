...
def get_sequence(fasta: typing.Optional[str] = None, sequence: typing.Optional[str] = None) -> tuple[str, str]:
    """
            ...
            try:
                with open(fasta, 'r') as f:
                    ...
                    if next(records_iter, None) is not None:
                        warnings.warn("Multiple sequences found in FASTA file, only the first sequence will be used")
